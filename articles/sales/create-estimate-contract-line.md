...
---
# <a name="estimate-a-projectbased-contract-line"></a>Estimere en prosjektbasert kontraktlinje
...
## <a name="create-an-estimate-directly-on-a-projectbased-contract-line"></a>Opprette et estimat direkte på en prosjektbasert kontraktlinje
...
| **Ressursstyringsfirma** | **Hurtigoppretting** | Ressursstyringsfirmaet eller den juridiske enheten som oppretter denne kostnaden og skaffer ressursen for å arbeide med den. | Dette feltet brukes som standard for den relaterte kontraktlinjedetaljen for kostnader som opprettes automatisk. Dette feltet brukes også ved henting av kostpris. |
