---
title: Overskriftsdetaljer for prosjektbaserte kontrakter
description: Denne artikkelen inneholder informasjon om feltene og informasjon om prosjektbaserte kontrakter i Project Operations.
author: rumant
ms.date: 10/20/2020
ms.topic: article
...
ms.locfileid: "9824404"
---
# <a name="header-details-for-project-based-contracts"></a>Overskriftsdetaljer for prosjektbaserte kontrakter

_**Gjelder for:** Project Operations for ressursbaserte/ikke-lagerbaserte scenarioer_

Denne artikkelen inneholder informasjon om felter som gjelder for hele prosjektkontrakten, inkludert innstillinger som påvirker alle kontraktlinjene. Informasjon om kontrakten som er oppsummert på tvers av alle linjeelementene for å drive KPI-er for prosjektkontrakten, er også inkludert.
