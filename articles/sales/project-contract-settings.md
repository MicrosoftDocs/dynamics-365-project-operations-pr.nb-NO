...
description: Denne artikkelen inneholder informasjon om feltene som påvirker kontraktlinjer, og informasjonen om kontrakten det oppsummeres til på tvers av alle linjeelementene.
author: rumant
ms.date: 10/20/2020
ms.topic: article
