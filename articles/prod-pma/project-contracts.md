...
description: Denne artikkelen inneholder eksempler på prosjektkontraktene som du kan opprette for ulike typer prosjekter og finansieringskilder, og hvordan du kan administrere kontrakter og fakturere prosjektkunder.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
