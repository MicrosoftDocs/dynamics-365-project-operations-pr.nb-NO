...
description: Denne artikkelen forklarer hvordan du oppretter betal-når-betalt (PWP), slik at du kan frigi delvise leverandørbetalinger basert på kundebetalinger.
author: RadhikaRS
ms.date: 03/30/2020
ms.topic: article
ms.prod: ''
