...
description: Denne artikkelen inneholder informasjon om hvordan prisdimensjoner kan brukes til å støtte prissetting og kostnad for en ressurs med flere roller på et prosjekt.
author: rumant
ms.custom:
