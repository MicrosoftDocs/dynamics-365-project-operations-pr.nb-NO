...
| **Ressursstyringsfirma** | Angi som standard fra de faktiske verdikildene. Et skrivebeskyttet felt som er låst for redigering. | Feltet kan redigeres på en ny fakturalinjedetalj som ikke blir støttet av en faktisk verdikilde. |
