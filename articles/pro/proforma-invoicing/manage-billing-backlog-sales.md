...
description: Denne artikkelen inneholder informasjon om de ulike visningene som er tilgjengelige for bruk ved administrasjon av faktureringsrestansen på prosjekter.
author: rumant
ms.date: 10/26/2020
ms.topic: article
