...
description: Denne artikkelen forklarer hvordan du oppretter en arbeidsnedbrytningsstruktur (WBS) for grunnleggende kontroller i det nye planleggingsgrensesnittet.
author: ruhercul
ms.date: 12/16/2021
ms.topic: article
