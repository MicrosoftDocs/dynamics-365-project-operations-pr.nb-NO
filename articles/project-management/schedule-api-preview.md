...
<span data-ttu-id="ed1a9-111">Tabellen nedenfor viser en fullstendig liste over prosjekttidsplanens enheter.</span><span class="sxs-lookup"><span data-stu-id="ed1a9-111">The following table provides a full list of the Project schedule entities.</span></span>
...
| <span data-ttu-id="ed1a9-201">msdyn_actualsales</span><span class="sxs-lookup"><span data-stu-id="ed1a9-201">msdyn_actualsales</span></span>                      | <span data-ttu-id="ed1a9-202">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-202">no</span></span>             | <span data-ttu-id="ed1a9-203">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-203">no</span></span>               |
...
| <span data-ttu-id="ed1a9-243">msdyn_LinkStatus</span><span class="sxs-lookup"><span data-stu-id="ed1a9-243">msdyn_LinkStatus</span></span>                       | <span data-ttu-id="ed1a9-244">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-244">no</span></span>             | <span data-ttu-id="ed1a9-245">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-245">no</span></span>               |
...
| <span data-ttu-id="ed1a9-285">msdyn_resourcecategory</span><span class="sxs-lookup"><span data-stu-id="ed1a9-285">msdyn_resourcecategory</span></span>                 | <span data-ttu-id="ed1a9-286">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-286">no</span></span>             | <span data-ttu-id="ed1a9-287">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-287">no</span></span>               |
...
| <span data-ttu-id="ed1a9-324">msdyn_skipupdateestimateline</span><span class="sxs-lookup"><span data-stu-id="ed1a9-324">msdyn_skipupdateestimateline</span></span>           | <span data-ttu-id="ed1a9-325">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-325">no</span></span>             | <span data-ttu-id="ed1a9-326">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-326">no</span></span>               |
...
| <span data-ttu-id="ed1a9-364">msdyn_successortask</span><span class="sxs-lookup"><span data-stu-id="ed1a9-364">msdyn_successortask</span></span>           | <span data-ttu-id="ed1a9-365">ja</span><span class="sxs-lookup"><span data-stu-id="ed1a9-365">yes</span></span>            | <span data-ttu-id="ed1a9-366">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-366">no</span></span>           |
...
| <span data-ttu-id="ed1a9-450">**Logisk navn**</span><span class="sxs-lookup"><span data-stu-id="ed1a9-450">**Logical name**</span></span>                                 | <span data-ttu-id="ed1a9-451">**Kan opprette**</span><span class="sxs-lookup"><span data-stu-id="ed1a9-451">**Can create**</span></span> | <span data-ttu-id="ed1a9-452">**Kan redigere**</span><span class="sxs-lookup"><span data-stu-id="ed1a9-452">**Can edit**</span></span> |
|--------------------------------------------------|----------------|--------------|
...
| <span data-ttu-id="ed1a9-489">msdyn_msprojectclientid</span><span class="sxs-lookup"><span data-stu-id="ed1a9-489">msdyn_msprojectclientid</span></span>                          | <span data-ttu-id="ed1a9-490">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-490">no</span></span>             | <span data-ttu-id="ed1a9-491">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-491">no</span></span>           |
...
| <span data-ttu-id="ed1a9-529">msdyn_contractorganizationalunitid</span><span class="sxs-lookup"><span data-stu-id="ed1a9-529">msdyn_contractorganizationalunitid</span></span>     | <span data-ttu-id="ed1a9-530">ja</span><span class="sxs-lookup"><span data-stu-id="ed1a9-530">yes</span></span>            | <span data-ttu-id="ed1a9-531">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-531">no</span></span>           |
...
| <span data-ttu-id="ed1a9-613">msdyn_remainingsales</span><span class="sxs-lookup"><span data-stu-id="ed1a9-613">msdyn_remainingsales</span></span>                   | <span data-ttu-id="ed1a9-614">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-614">no</span></span>             | <span data-ttu-id="ed1a9-615">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-615">no</span></span>           |
...
| <span data-ttu-id="ed1a9-652">msdyn_teamsize_date</span><span class="sxs-lookup"><span data-stu-id="ed1a9-652">msdyn_teamsize_date</span></span>                    | <span data-ttu-id="ed1a9-653">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-653">no</span></span>             | <span data-ttu-id="ed1a9-654">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-654">no</span></span>           |
| <span data-ttu-id="ed1a9-655">msdyn_teamsize_state</span><span class="sxs-lookup"><span data-stu-id="ed1a9-655">msdyn_teamsize_state</span></span>                   | <span data-ttu-id="ed1a9-656">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-656">no</span></span>             | <span data-ttu-id="ed1a9-657">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-657">no</span></span>           |
| <span data-ttu-id="ed1a9-658">msdyn_totalactualcost</span><span class="sxs-lookup"><span data-stu-id="ed1a9-658">msdyn_totalactualcost</span></span>                  | <span data-ttu-id="ed1a9-659">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-659">no</span></span>             | <span data-ttu-id="ed1a9-660">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-660">no</span></span>           |
| <span data-ttu-id="ed1a9-661">msdyn_totalactualcost_base</span><span class="sxs-lookup"><span data-stu-id="ed1a9-661">msdyn_totalactualcost_base</span></span>             | <span data-ttu-id="ed1a9-662">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-662">no</span></span>             | <span data-ttu-id="ed1a9-663">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-663">no</span></span>           |
| <span data-ttu-id="ed1a9-664">msdyn_totalplannedcost</span><span class="sxs-lookup"><span data-stu-id="ed1a9-664">msdyn_totalplannedcost</span></span>                 | <span data-ttu-id="ed1a9-665">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-665">no</span></span>             | <span data-ttu-id="ed1a9-666">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-666">no</span></span>           |
| <span data-ttu-id="ed1a9-667">msdyn_totalplannedcost_base</span><span class="sxs-lookup"><span data-stu-id="ed1a9-667">msdyn_totalplannedcost_base</span></span>            | <span data-ttu-id="ed1a9-668">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-668">no</span></span>             | <span data-ttu-id="ed1a9-669">nei</span><span class="sxs-lookup"><span data-stu-id="ed1a9-669">no</span></span>           |


## <a name="limitations-and-known-issues"></a><span data-ttu-id="ed1a9-670">Begrensninger og kjente problemer</span><span class="sxs-lookup"><span data-stu-id="ed1a9-670">Limitations and known issues</span></span>
<span data-ttu-id="ed1a9-671">Nedenfor vises en liste over begrensninger og kjente problemer:</span><span class="sxs-lookup"><span data-stu-id="ed1a9-671">The following is a list of limitations and known issues:</span></span>

- <span data-ttu-id="ed1a9-672">API-er for prosjektplan kan bare brukes av **brukere med Microsoft Project-lisens.**</span><span class="sxs-lookup"><span data-stu-id="ed1a9-672">Project Schedule APIs can only be used by **Users with Microsoft Project License.**</span></span> <span data-ttu-id="ed1a9-673">De kan ikke brukes av følgende:</span><span class="sxs-lookup"><span data-stu-id="ed1a9-673">They can't be used by:</span></span>
    - <span data-ttu-id="ed1a9-674">Applikasjonsbrukere</span><span class="sxs-lookup"><span data-stu-id="ed1a9-674">Application users</span></span>
    - <span data-ttu-id="ed1a9-675">Systembrukere</span><span class="sxs-lookup"><span data-stu-id="ed1a9-675">System users</span></span>
    - <span data-ttu-id="ed1a9-676">Integreringsbrukere</span><span class="sxs-lookup"><span data-stu-id="ed1a9-676">Integration users</span></span>
    - <span data-ttu-id="ed1a9-677">Andre brukere som ikke har den nødvendige lisensen</span><span class="sxs-lookup"><span data-stu-id="ed1a9-677">Other users that don't have the required license</span></span>
- <span data-ttu-id="ed1a9-678">Hvert **OperationSet** kan bare ha maksimalt 100 operasjoner.</span><span class="sxs-lookup"><span data-stu-id="ed1a9-678">Each **OperationSet** can only have a maximum of 100 operations.</span></span>
- <span data-ttu-id="ed1a9-679">Hver bruker kan bare ha maksimalt 10 åpne **OperationSets**.</span><span class="sxs-lookup"><span data-stu-id="ed1a9-679">Each user can only have a maximum of 10 open **OperationSets**.</span></span>
- <span data-ttu-id="ed1a9-680">Project Operations støtter for øyeblikket maksimalt 500 oppgaver på et prosjekt.</span><span class="sxs-lookup"><span data-stu-id="ed1a9-680">Project Operations currently supports a maximum of 500 total tasks on a project.</span></span>
- <span data-ttu-id="ed1a9-681">**OperationSet**-feilstatus og -feillogger er ikke tilgjengelige for øyeblikket.</span><span class="sxs-lookup"><span data-stu-id="ed1a9-681">**OperationSet** failure status and failure logs aren't currently available.</span></span>
- [<span data-ttu-id="ed1a9-682">Begrensninger og grenser for prosjekter og oppgaver</span><span class="sxs-lookup"><span data-stu-id="ed1a9-682">Limits and boundaries on projects and tasks</span></span>](/project-for-the-web/project-for-the-web-limits-and-boundaries)

## <a name="error-handling"></a><span data-ttu-id="ed1a9-683">Feilbehandling</span><span class="sxs-lookup"><span data-stu-id="ed1a9-683">Error handling</span></span>

   - <span data-ttu-id="ed1a9-684">Hvis du vil se gjennom feil som genereres fra operasjonssettene, går du til **Innstillinger** \> **Planlegg integrasjon** \> **Operasjonssett**.</span><span class="sxs-lookup"><span data-stu-id="ed1a9-684">To review errors generated from the Operation Sets, go to **Settings** \> **Schedule Integration** \> **Operations Sets**.</span></span>
   - <span data-ttu-id="ed1a9-685">Hvis du vil se gjennom feil som genereres fra prosjektplantjenesten, går du til **Innstilling** \> **Planlegg integrering** \> **PSS-feillogger**.</span><span class="sxs-lookup"><span data-stu-id="ed1a9-685">To review errors generated from the Project schedule Service, go to **Settings** \> **Schedule Integration** \> **PSS Error Logs**.</span></span>

## <a name="sample-scenario"></a><span data-ttu-id="ed1a9-686">Eksempelscenario</span><span class="sxs-lookup"><span data-stu-id="ed1a9-686">Sample scenario</span></span>

<span data-ttu-id="ed1a9-687">I dette scenarioet skal du opprette et prosjekt, et teammedlem, fire oppgaver og to ressurstilordninger.</span><span class="sxs-lookup"><span data-stu-id="ed1a9-687">In this scenario, you will create a project, a team member, four tasks, and two resource assignments.</span></span> <span data-ttu-id="ed1a9-688">Deretter skal du oppdatere én oppgave, oppdatere prosjektet, slette én oppgave, slette én ressurstilordning og opprette en aktivitetsavhengighet.</span><span class="sxs-lookup"><span data-stu-id="ed1a9-688">Next, you will update one task, update the project, delete one task, delete one resource assignment, and create a task dependency.</span></span>
...
## <a name="additional-samples"></a><span data-ttu-id="ed1a9-689">Flere eksempler</span><span class="sxs-lookup"><span data-stu-id="ed1a9-689">Additional samples</span></span>
