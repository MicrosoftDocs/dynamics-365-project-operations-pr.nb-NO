...
- Hvis du oppretter en ny mal, må du legge til denne kolonnen. Velg **Legg til betinget kolonne** i Power Query, og skriv inn et navn for den nye kolonnen, for eksempel **Modell-ID**. Angi betingelsen for kolonnen, der du, hvis prosjektoppgave ikke er null, skal \<angi prognosemodell-ID-en\>. Ellers null.
...
[![Maltilordning](./media/ProjectHourEstimatesMapping.jpg)](./media/ProjectHourEstimatesMapping.jpg)
...
- Hvis du oppretter en ny mal, må du legge til denne kolonnen. Velg **Legg til betinget kolonne** i Power Query, og skriv inn et navn for den nye kolonnen, for eksempel **Modell-ID**. Angi betingelsen for kolonnen, der du, hvis estimatlinje-ID ikke er null, skal \<angi prognosemodell-ID-en\>. Ellers null.
...
[![Maltilordning](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)

[![Maltilordning](./media/ExpenseEstimatesMapping.jpg)](./media/ExpenseEstimatesMapping.jpg)
